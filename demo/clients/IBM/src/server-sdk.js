...
async function issueProof(port = '', data) {
	// console.log(data);
	const response = await fetch(`http://localhost:${port}/present-proof/send-request`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
...
async function fetchProof(port = '') {
	// console.log(data);
	const response = await fetch(`http://localhost:${port}/present-proof/records`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json'
		},
...
async function verifyPresentation(port = '', id) {
	// console.log(data);
	const response = await fetch(`http://localhost:${port}/present-proof/records/${id}/verify-presentation`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
